...
(
	...
	CONSTRAINT FK_PREGUNTA_USUARIO FOREIGN KEY (ID_USUARIO) REFERENCES USUARIO (ID_USUARIO) ON UPDATE CASCADE
);
...
(
	...
	FECHARESPUESTA VARCHAR (30) NOT NULL,
	ID_PREGUNTA INT NOT NULL,
	ID_USUARIO BIGINT NOT NULL,
	PRIMARY KEY (ID_RESPUESTA),
	CONSTRAINT FK_RESPUESTA_PREGUNTA FOREIGN KEY (ID_PREGUNTA) REFERENCES PREGUNTA (ID_PREGUNTA) ON UPDATE CASCADE,
